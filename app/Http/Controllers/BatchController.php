...
class BatchController extends Controller
{
    ...
    {
        $data = Batch::orderBy('updated_at', 'desc')->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        Batch::where('id', $id)->update($validated);
        return response()->json(['message' => 'Batch updated successfully!', 'redirect' => route('batches.index')]);
    }
