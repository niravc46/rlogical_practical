            ...
            <form action="{{ route('batches.store') }}" method="POST" id="batchForm">
                ...
                <div class="module-block">
                    <div class="row ">
                        ...
                        <div class="col-md-4">
                            <input readonly type="text" class="form-control datepicker" id="module1End"
                                name="module1_end">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control datepicker" id="module2Start" name="module2_start"
                                value="07/08/2023" required>
                        </div>
                        <div class="col-md-4">
                            <input type="text" class="form-control datepicker" id="module2End" name="module2_end"
                                readonly>
                        </div>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control datepicker" id="module3Start"
                                name="module3_start" required>
                        </div>
                        <div class="col-md-4">
                            <input type="text" class="form-control datepicker" id="module3End" name="module3_end"
                                readonly>
                        </div>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control datepicker" id="module4Start"
                                name="module4_start" value="07/08/2023" required>
                        </div>
                        <div class="col-md-4">
                            <input type="text" class="form-control datepicker" id="module4End" name="module4_end"
                                value="11/08/2023" readonly>
                        </div>
